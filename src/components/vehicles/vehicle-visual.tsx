      ...
      <div className="absolute inset-0 flex items-center justify-center px-6 pt-10 sm:px-8">
        ...
        {vehicle.images?.[0]?.url ? (
          ...
          <img
            ...
            className={cn(
              "relative z-10 h-auto max-h-[58%] w-[75%] object-contain drop-shadow-[0_28px_30px_rgb(0_0_0_/_70%)] transition-transform duration-500 group-hover/visual:scale-[1.04]",
