...
export function IncomingPreviewSection() {
  const incomingVehicles = getVehiclesByStatus("INCOMING").slice(0, 2);
                  ...
                  <div className="flex flex-col p-6">
                    ...
                    <div className="mt-6 space-y-3 text-xs text-muted-foreground">
                      <p className="flex items-center gap-2">
                        ...
                        Origin: {vehicle.importOrigin ?? "International"}
                      </p>
                      ...
                      <p className="flex items-center gap-2">
                        ...
                        {vehicle.eta ?? "Arrival date pending"}
                      </p>
                    </div>
