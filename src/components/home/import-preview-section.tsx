...
export function ImportPreviewSection() {
  const importOpportunity =
    getVehiclesByStatus("IMPORTABLE")[0];
          ...
          {importOpportunity ? (
              ...
              <div className="grid h-full md:grid-cols-[1.05fr_0.95fr]">
                ...
                <div className="flex flex-col p-6 sm:p-8">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    >
                      {importOpportunity.importOrigin}
                    </Badge>
                  </div>
                  ...
                  <div className="mt-6 border-y border-white/10 py-5">
                    ...
                    <p className="mt-2 text-2xl font-semibold">
                      {formatVehiclePrice(importOpportunity.price)}
                    </p>
                  </div>
                  ...
                  <div className="mt-5 flex items-start gap-3">
                    ...
                    <p className="text-xs leading-6 text-muted-foreground">
                      Final sourcing availability, inspection information and
                      landed quotation will be confirmed before purchase.
                    </p>
                  </div>
            ...
            <div className="grid min-h-96 place-items-center border border-dashed border-white/15 bg-white/[0.025] p-8 text-center">
              <div>
                ...
                <p className="mt-3 text-sm leading-7 text-muted-foreground">
                  Submit your preferred vehicle requirements and receive
                  guided sourcing assistance.
                </p>
        ...
        <div className="mt-8 flex flex-col items-start justify-between gap-5 border border-white/10 bg-white/[0.025] p-6 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-2 text-sm leading-7 text-muted-foreground">
              Share your specifications and let the team prepare a
              personalised sourcing direction.
            </p>
          </div>
