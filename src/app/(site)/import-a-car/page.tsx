...
export default function ImportCarPage() {
  const importableVehicles =
    getVehiclesByStatus("IMPORTABLE");
    ...
    <>
      ...
      >
        <div className="flex flex-wrap gap-3">
          {serviceBenefits.slice(0, 3).map((benefit) => (
            <span
              key={benefit}
        ...
        <div className="grid gap-12 lg:grid-cols-[0.78fr_1.22fr]">
          <div>
            ...
            <p className="mt-4 text-sm leading-7 text-muted-foreground">
              The demonstration presents a clear customer journey. Exact
              quotations, payment stages and contractual terms will be added
              when the client confirms the final business process.
            </p>
        ...
        <div className="tm-container py-14 sm:py-16 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr]">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-muted-foreground">
                Customers receive a coordinated experience rather than
                managing sourcing, inspection, shipping and clearance
                independently.
              </p>
            </div>
      ...
      {importableVehicles.length > 0 && (
        <section className="tm-container py-14 sm:py-16 lg:py-20">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-sm leading-7 text-muted-foreground">
              These demonstration listings represent vehicles that could be
              sourced through the assisted-import service.
            </p>
          </div>

          <div className="mt-9 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {importableVehicles.map((vehicle) => (
              <VehicleCard
                key={vehicle.id}
                vehicle={vehicle}
              />
