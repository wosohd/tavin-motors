...
} from "@/components/marketplace/marketplace-listing-card";
...
export default async function MarketplaceListingPage({
  ...
  /*
   * The public marketplace only
   * exposes listings that have
          ...
          <div>
...

            {
              ...
              0 ? (
                ...
                <div className="mt-8 border border-dashed border-white/15 bg-white/[0.025] p-6">

                  <p className="text-sm text-muted-foreground">
                    No additional equipment details were provided by the seller.
                  </p>
