...
export default function IncomingVehiclesPage() {
  const incomingVehicles = getVehiclesByStatus("INCOMING");
    ...
    <>
      ...
      >
        <div className="flex flex-wrap gap-x-8 gap-y-3 text-sm text-muted-foreground">
          ...
          <p>
            <strong className="text-white">Early</strong>{" "}
        ...
        <div className="tm-container py-14 sm:py-16 lg:py-20">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-sm leading-7 text-muted-foreground">
              Every incoming vehicle moves through a structured sourcing,
        ...
        <div className="relative overflow-hidden border border-brand-gold/20 bg-brand-gold/[0.045] p-7 sm:p-10">
          ...
          <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-sm leading-7 text-muted-foreground">
                Submit your requirements and let Tavin Motors source a vehicle
                suited to your preferences, budget and intended use.
              </p>
            </div>
